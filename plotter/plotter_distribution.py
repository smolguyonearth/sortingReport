...
# File names for the log files (adapt for your case)
log_files = [
    "distribution_count_log_original.txt",
    "distribution_count_log_mintomax.txt",
    "distribution_count_log_maxtomin.txt"
]
...
plt.title('DistributionCounting Sort Time Complexity (Linear Scale)', fontsize=16)
