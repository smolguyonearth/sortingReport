...
# # log_files = [
# #     "quicksort_log_original.txt",
# #     "quicksort_log_mintomax.txt",
# #     "quicksort_log_maxtomin.txt"
# # ]
...
# # plt.title('Quick Sort Time Complexity', fontsize=16)
...
# # Add titles and labels
# plt.title('Quick Sort Time Complexity (Linear Scale)', fontsize=16)
# plt.xlabel('Input Size (N)', fontsize=14)
# plt.ylabel('Time (seconds)', fontsize=14)
...
# File names for the log files
log_files = [
    "log/quicksort_log_original.txt",
    "log/quicksort_log_mintomax.txt",
    "log/quicksort_log_maxtomin.txt"
]
