...
# log_files = [
#     "selectionsort_log_original.txt",
#     "selectionsort_log_mintomax.txt",
#     "selectionsort_log_maxtomin.txt"
# ]
...
# plt.title('Selection Sort Time Complexity', fontsize=16)
...
# File names for the log files
log_files = [
    "log/selectionsort_log_original.txt",
    "log/selectionsort_log_mintomax.txt",
    "log/selectionsort_log_maxtomin.txt"
]
...
# Add titles and labels
plt.title('Selection Sort Time Complexity (Linear Scale)', fontsize=16)
plt.xlabel('Input Size (N)', fontsize=14)
plt.ylabel('Time (seconds)', fontsize=14)
