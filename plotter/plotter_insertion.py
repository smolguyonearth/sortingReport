...
# log_files = [
#     "insertionsort_log_original.txt",
#     "insertionsort_log_mintomax.txt",
#     "insertionsort_log_maxtomin.txt"
# ]
...
# plt.title('Insertion Sort Time Complexity', fontsize=16)
...
# File names for the log files
log_files = [
    "log/insertionsort_log_original.txt",
    "log/insertionsort_log_mintomax.txt",
    "log/insertionsort_log_maxtomin.txt"
]
...
# Add titles and labels
plt.title('Insertion Sort Time Complexity (Linear Scale)', fontsize=16)
plt.xlabel('Input Size (N)', fontsize=14)
plt.ylabel('Time (seconds)', fontsize=14)
